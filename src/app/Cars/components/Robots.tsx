import {
  ...
  const Robots = () => {
    ...
    const [selectedVehicle, setSelectedVehicle] = useState<string>("Bellabot");
    ...
    const vehicles = ["Bellabot", "Star Butler", "Flippy"];
    ...
    return (
      <Grid container>
        ...
        >
          ...
          >
            <Typography variant="h3">{t("adtype.vehicles.Robots")}</Typography>
          </Box>
